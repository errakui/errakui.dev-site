...
export default function RootLayout({
  ...
  return (
    <html lang="it-CH">
      <head>
        {/* Google Analytics */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-SVGRE9DYVP" />
        <script
        ...
        <noscript>
          <img 
            ...
            width="1" 
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=890448080300641&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* Microsoft Clarity */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "v6ts0szrr2");
            `,
          }}
        />
        <script
